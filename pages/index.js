...
export const appName = "Synbio by Text";
export const appSubtitle = "Start with a basic Insulin sequence and edit it to create smth new using written instructions, with the help of an AI.";
export const appMetaDescription = "Start with a basic Insulin sequence and edit it to create smth new using written instructions, with the help of an AI.";
